...
test('Scans EAN/UPC Book Barcode', async () => {
    ...
    // finish scanning will cause the beacon request to be scheduled
    await page.getByText('FINISH SCANNING').click();

    // add a little delay for the Beacon request to be sent
